          ...
          <div>
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="aspect-video overflow-hidden">
                <img 
                  src="./Saree_Images/womaninblue.avif" 
                  alt="Store Interior" 
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">info@Weavelle.com</p>
                      <p className="text-gray-600">support@Weavelle.com</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="https://www.instagram.com/weavelle_/#" target="_blank" className="bg-saree-maroon/10 p-3 rounded-full hover:bg-saree-maroon/20 transition-colors">
                    ...
                    <a href="https://www.youtube.com/@weavellebykhadisilk" target="_blank" className="bg-saree-maroon/10 p-3 rounded-full hover:bg-saree-maroon/20 transition-colors">
                      <Youtube size={20} className="text-saree-maroon" />
                    </a>
                  </div>
                </div>
              </div>
