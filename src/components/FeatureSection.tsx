...
const features = [
  {
    id: 1,
    icon: "https://img.icons8.com/cotton/64/000000/handmade.png",
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-700 mb-6">
                At DrapeDream, we take pride in sourcing only the finest fabrics and partnering with skilled artisans who share our passion for preserving traditional techniques while embracing contemporary designs.
              </p>
            ...
            <div className="relative">
              <div className="aspect-square overflow-hidden rounded-lg">
                <img 
                  src="https://images.unsplash.com/photo-1629514849593-2a55f1d000a8?w=600&auto=format&fit=crop&q=80" 
